...
impl MaxEid {
    ...
    pub async fn read<S: ReadWriteStorage + TrieReadPolicy<Config = HandleTrieConfig>>(trie: &Trie<S>) -> Result<Self, QueryError> {
    ...
    pub async fn write<S: ReadWriteStorage + TrieReadPolicy<Config = HandleTrieConfig>>(
        self,
        trie: Trie<S>,
