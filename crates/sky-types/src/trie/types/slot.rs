...
use crate::trie::{
    HashKey, MapBase, Base, SlotMap, TrieCommit, RootBaseRead, TrieInsertError,
...
impl Slot {
    ...
    pub async fn query_key_values<P: RootBaseRead>(
        &self,
        storage: &P,
    ...
    pub async fn query_value<P: RootBaseRead>(
        &self,
        key: HashKey,
        storage: &P,
